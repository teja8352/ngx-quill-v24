# Credits to https://github.com/KillerCodeMonkey

# ngx-quill ![Build Status](https://github.com/KillerCodeMonkey/ngx-quill-v24/workflows/CI/badge.svg)

<img src="https://cloud.githubusercontent.com/assets/2264672/20601381/a51753d4-b258-11e6-92c2-1d79efa5bede.png" width="200px">

Worked on top of ngx-quill(24.0.0)

ngx-quill is updatrd with Quill V2. ngx-quill is an angular (>=2) module for the [Quill Rich Text Editor](https://quilljs.com/) containing all components you need.
...
It's possible to set custom default modules and Quill config options with the import of the `QuillConfigModule` from the `ngx-quill-v24/config`. This module provides a global config, but eliminates the need to import the `ngx-quill` library into the vendor bundle:

```ts
import { QuillConfigModule } from 'ngx-quill-v24/config';
...
```ts
import { provideQuillConfig } from 'ngx-quill-v24/config';
